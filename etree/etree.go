...
func (d *Document) ReadFrom(r io.Reader, isFixed bool) (n int64, err error) {
...
// document.
func (d *Document) ReadFromFile(filepath string, isFixed bool) error {
